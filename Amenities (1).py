...
long_cafe = pd.melt(nth_nearest_cafe,id_vars=['Neighborhood'],var_name='N', value_name='Av Cafe Dist')
long_res = pd.melt(nth_nearest_res,id_vars=['Neighborhood'],var_name='N', value_name='Av Res Dist')
long_bar = pd.melt(nth_nearest_bar,id_vars=['Neighborhood'],var_name='N', value_name='Av Bar Dist')
long_nc = pd.melt(nth_nearest_cafe,id_vars=['Neighborhood'],var_name='N', value_name='Av NC Dist')
...
format_data = [('Cafes', 0, 1000,'0 m', 'Cafes'),
               ('Restaurants', 0, 1000,'0 m', 'Restaurants'),
               ('Bars', 0, 1000,'0 m', 'Bars'),
               ('Nightclubs', 0, 1000,'0 m', 'Nightclubs')]
...
hover = HoverTool(tooltips = [ ('Neighborhood','@Neighborhood'),
                               ('Average Distance to Nth Nearest Cafe (m)', '@Av Cafe Dist'),
                               ('Average Distance to Nth Nearest Restaurant (m)', '@Av Res Dist'),
                               ('Average Distance to Nth Nearest Bar (m)', '@Av Bar Dist'),
                               ('Average Distance to Nth Nearest Nightclub (m)', '@Av NC Dist') ] )
