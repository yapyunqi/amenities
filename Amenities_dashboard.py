...
nhoods = gpd.read_file("https://raw.githubusercontent.com/yapyunqi/amenities/master/Neighborhood Tabulation Areas.geojson")
nhoods.rename(columns = {'ntaname':'Neighborhood'}, inplace = True)
nhoods.crs = {'init': 'epsg:4326'}

# adding boroughs file
import geopandas as gpd
boroughs = gpd.read_file("https://raw.githubusercontent.com/yapyunqi/amenities/master/Borough Boundaries.geojson")
